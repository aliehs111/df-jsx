    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow rounded space-y-6">
      ...
      <section className="space-y-2">
        ...
        <label className="inline-flex items-center">
          <input
            ...
            onChange={(e) =>
              setClean((c) => ({ ...c, dropna: e.target.checked }))
            }
            className="mr-2"
          />
        ...
        <label className="inline-flex items-center">
          <input
            ...
            onChange={(e) =>
              setClean((c) => ({ ...c, lowercase_headers: e.target.checked }))
            }
            className="mr-2"
          />
        ...
        <label className="inline-flex items-center">
          <input
            ...
            onChange={(e) =>
              setClean((c) => ({ ...c, remove_duplicates: e.target.checked }))
            }
            className="mr-2"
          />
      ...
      <section className="space-y-2">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setPreprocess((p) => ({ ...p, scale: e.target.value }))
            }
            className="mt-1 w-full border px-2 py-1 rounded"
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setPreprocess((p) => ({ ...p, encoding: e.target.value }))
            }
            className="mt-1 w-full border px-2 py-1 rounded"
          >
            <option value="">None</option>
      ...
      {result && (
        <div className="p-4 bg-green-100 rounded">
          <p>
            <strong>Done!</strong> Final CSV in S3 at{" "}
            <code>{result.s3_key}</code>
          </p>
        </div>
      )}
    </div>
